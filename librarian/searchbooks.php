		...
		<div class="margin-top">
			...
			<div class="span12">	
								    ...
								    <ul class="nav nav-pills">
										<li  class="active"><a href="searchbooks.php">All</a></li>
										<li><a href="new_books.php" color="black">New Books</a></li>
						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="10px" cellspacing="0" border="1px solid blue" class="table  table-bordered" id="example">
